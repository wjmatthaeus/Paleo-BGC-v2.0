...
psn_struct* psn_sun, psn_struct* psn_shade, summary_struct* summary)
{
	...
	if (ok)
	{
		...
		output_map[547] = &epv->m_Kl;
		output_map[548] = &epv->leaf_psi;
                output_map[549] = &epv->d13C_leaf_sun;
                output_map[550] = &epv->d13C_leaf_shade;
                output_map[551] = &epv->m_psi_x; /*WJM 0821*/
		...
		output_map[646] = &summary->daily_snoww;
                output_map[647] = &summary->vegn;
		output_map[648] = &summary->litrn;
		output_map[649] = &summary->soiln;
		output_map[650] = &summary->totaln;
	}
